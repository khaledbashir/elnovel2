...
import InteractableNovelEditor from "@/components/tambo/novel-editor";

export default function NovelDemoPage() {
    ...
    content: [
      {
        ...
        content: [
          {
            type: "text",
            text: "Start writing your novel here...",
          },
        ],
      },
    ],
            ...
            <>
              <div className="p-4 border-b border-gray-200">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Try: "Rename the story to 'The Last Star'" or "Add a new chapter about space travel"
                </p>
              </div>
              ...
              <div className="p-4 border-t border-gray-200">
                <MessageInput
                  contextKey="novel-demo"
                  variant="bordered"
                >
                  <MessageInputTextarea placeholder="Ask for help with your story..." />
                  <MessageInputToolbar>
                    <MessageInputSubmitButton />
                  </MessageInputToolbar>
                </MessageInput>
